...
pygame.display.set_caption("SPACE SW!")
...
def show_go_screen():
    ...
    draw_text(screen, "SPACE SW!", 64, WIDTH / 2, HEIGHT / 4)
    draw_text(screen, "Двигаться стрелками, нажмите 'space' чтобы стрелять", 22,
              WIDTH / 2, HEIGHT / 2)
